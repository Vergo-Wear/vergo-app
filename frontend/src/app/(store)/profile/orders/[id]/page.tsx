...
export default function OrderDetailsPage({
  ...
  const handleFileChange = (e: React.ChangeEvent<HTMLInputElement>) => {
    ...
    if (!allowedTypes.includes(file.type)) {
      setUploadError(
        "Format rejected. Please choose a JPG, PNG, WEBP image or PDF.",
      );
      setSelectedFile(null);
      return;
    }
        ...
        <div className="orders-container">
          <div className="empty-orders-container">
            ...
            <p className="empty-orders-desc">
              You are not authorized to view this order record. If this is a
        ...
        >
          ...
          >
            {statusStr === "completed" ? (
              ...
              <span style={{ color: "#ff4d4d" }}>
                Payment receipt was rejected by administration
              </span>
            ) : statusStr === "expired" ? (
              <span style={{ color: "#ff8c8c" }}>
                Awaiting payment window elapsed
              </span>
            ) : (
        ...
        {order.paymentMethod === "bank_transfer" &&
          (payStatusLower === "pending payment" ||
            ...
            >
              ...
              >
                Please upload your bank transfer receipt (screenshot or
                transaction PDF).
                <br />
                Supported formats: <strong>JPG, PNG, WEBP, PDF</strong>. Maximum
                file size: <strong>5MB</strong>.
              </p>
              ...
              >
                ...
                >
                  <button
                    ...
                    onClick={() =>
                      document
                        .getElementById("payment-proof-file-input")
                        ?.click()
                    }
                  ...
                  <span
                    style={{
                      fontSize: "12px",
                      color: selectedFile ? "#ffffff" : "rgba(255,255,255,0.3)",
                    }}
                  >
        ...
        <div className="order-detail-grid">
          ...
          <div className="order-detail-main">
                  ...
                  return (
                    <div className="detail-product-row" key={item.orderItemId}>
                      ...
                      <div className="detail-product-info">
                        ...
                        <p
                          className="order-product-collection"
                        ...
                        <div
                          className="order-product-options"
                      ...
                      <div style={{ textAlign: "right" }}>
                        ...
                        <div
                          className="detail-product-total"
            ...
            <div className="info-summary-grid">
              ...
              <div className="order-detail-card">
                <h3
                  className="order-detail-card-title"
                  style={{
                    fontSize: "0.75rem",
                    display: "flex",
                    alignItems: "center",
                  ...
                  {order.paymentMethod === "bank_transfer" && (
                    <div>
                      ...
                      >
                        ...
                        <br />
                        Reference: VRG-
                        {order.orderId.substring(0, 6).toUpperCase()}-WEB
                      </div>
                    </div>
                  )}
                    ...
                    <div style={{ marginTop: "4px" }}>
                      <span
                        className={`status-pill payment-status-${
                          payStatusLower.includes("approved") ||
                          payStatusLower.includes("paid")
                            ? "approved"
                            : payStatusLower.includes("reject")
                              ? "rejected"
                              : payStatusLower.includes("expired")
                                ? "expired"
                                : "pending"
                        }`}
                      >
