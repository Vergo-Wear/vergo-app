...
export default function EmployeesPage() {
  ...
  const [logs, setLogs] = useState<EmployeeLog[]>([
    {
      ...
      time: "23:09:42",
      name: "Alex Rivera",
      action: "Assigned Waybill KB-90485923",
      node: "NODE_LA_01",
    },
    {
      id: "l2",
      time: "22:54:11",
      name: "Jordan Smith",
      action: "Verified Stock count (+50 SKU: VGO-PANT-O-M)",
      node: "NODE_NY_04",
    },
    {
      id: "l3",
      time: "22:15:02",
      name: "Marcus V.",
      action: "Authorized Stock Transfer (LA-01 -> NY-04)",
      node: "NODE_LA_01",
    },
    {
      id: "l4",
      time: "21:40:59",
      name: "Alex Rivera",
      action: "Dispatched 12 packages to Koombiyo",
      node: "NODE_LA_01",
    },
  ]);
  ...
  const activeShiftsCount = employees.filter(
    (e) => e.status === "ON SHIFT",
  ).length;
  ...
  const validateForm = (): boolean => {
    ...
    if (
      ...
      Number.isNaN(Number(form.commissionPerParcel)) ||
      Number(form.commissionPerParcel) < 0
    ) {
      errors.commissionPerParcel = "Enter a non-negative commission rate.";
    }
    ...
    <div className="space-y-8 select-none text-xs">
      <div className="flex items-start justify-between">
        <div>
          ...
          <p className="text-[10px] text-[#8e8e93] mt-1 uppercase font-semibold">
            Monitor employee performance, toggle shifts, and audit live
            operations logs
          </p>
        </div>
        <button
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        ...
        <div className="admin-card p-6">
          ...
          <div className="text-2xl font-bold text-white mt-2 font-mono-meta">
            {employees.length}{" "}
            {employees.length === 1 ? "Staff Member" : "Staff"}
          </div>
        </div>
        <div className="admin-card p-6">
          <h4 className="text-[9px] font-bold text-[#8e8e93] tracking-widest uppercase">
                ...
                >
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      ...
                      <p className="text-[10px] text-[#8e8e93] font-bold tracking-wider mt-1 uppercase">
                        ASSIGNED: NODE_LA_01
                      </p>
                    </div>
                  </div>
                  ...
                  <div className="flex items-center gap-6">
                    <div className="text-right">
                      <div className="text-[9px] text-[#8e8e93] font-bold tracking-wider uppercase mb-0.5">
                        PARCELS DISPATCHED
                      </div>
                      <div className="font-mono-meta font-bold text-white text-sm">
                        {emp.parcels} units
                      </div>
                    </div>
                    ...
                    <button
                      onClick={() =>
                        setRemoveTarget({ id: emp.id, name: emp.name })
                      }
          ...
          <div className="admin-card p-6">
            ...
            <div className="space-y-4 max-h-[300px] overflow-y-auto pr-1 custom-scrollbar">
              {logs.map((log) => (
                <div
                  key={log.id}
                  className="text-xs border-b border-[rgba(255,255,255,0.02)] pb-3 last:border-0 last:pb-0"
                >
                  <div className="flex justify-between items-center mb-1">
                    <span className="font-bold text-white">{log.name}</span>
                    <span className="font-mono-meta text-[10px] text-[#8e8e93]">
                      {log.time} UTC
                    </span>
                  </div>
                  <p className="text-[#8e8e93] font-medium leading-relaxed">
                    {log.action}
                  </p>
                  <div className="text-[9px] font-mono-meta font-bold text-[#8e8e93] mt-1">
                    NODE: {log.node}
                  </div>
                </div>
              ))}
          ...
          >
            ...
            >
              ...
              <div>
                <label className="block text-[10px] font-bold text-[#8e8e93] tracking-wider uppercase mb-1.5">
                  ADDRESS{" "}
                  <span className="text-[#555] normal-case">(optional)</span>
                </label>
                <input
                  type="text"
                  value={form.address}
              ...
              <p className="text-[10px] text-[#8e8e93] leading-relaxed">
                A login account is created for this email. The login password is
                shown after creation — share it with the employee.
              </p>
          ...
          >
            ...
            <div className="space-y-4 text-xs">
              <p className="text-[#8e8e93] leading-relaxed">
                ...
                ? This permanently deletes their login account, profile, and
                employee record. This action cannot be undone.
              </p>
